...
#   timestamp: 2025-06-28T15:11:46+00:00
...
class CertificateParameters(BaseModel):
    ...
    PolDOB: str = Field(..., description='Date of Birth', examples=['yyyy-mm-dd'])
    PolicyNo: str = Field(
        ..., description='Policy Number', examples=['Enter Policy Number']
    )
